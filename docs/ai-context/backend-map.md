...
- `backend/internal/repository/notification_subscription_repository.go`, `backend/internal/repository/memory/notification_subscription_repository.go`, `backend/internal/repository/postgres/notification_subscription_repository.go`: notification target/subscription lookup for terminal build events; targets are durable recipients and subscriptions scope them to projects or jobs.
