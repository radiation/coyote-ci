...
- `backend/internal/service/build/notifications.go`: top-level build-notification entrypoints and orchestration for terminal build events and sample sends.
...
- `backend/internal/service/build/notification_format.go`: email and Slack content rendering plus build-detail formatting helpers.
...
- `backend/internal/service/notification_service.go`, `backend/internal/service/notification_targets.go`, `backend/internal/service/notification_subscriptions.go`, `backend/internal/service/notification_defaults.go`, `backend/internal/service/notification_preferences.go`: shared notification service wiring plus split target CRUD, subscription CRUD, instance default management, and self-scoped commit-author preference behavior.
...
- `backend/internal/http/handler/notification_handler.go`, `backend/internal/http/handler/notification_targets_handler.go`, `backend/internal/http/handler/notification_subscriptions_handler.go`, `backend/internal/http/handler/notification_preferences_handler.go`, `backend/internal/http/handler/notification_slack_workspace_handler.go`, `backend/internal/http/handler/notification_personal_slack_identity_handler.go`: shared notification handler wiring plus split target, subscription, preference, Slack workspace, and personal Slack identity HTTP surfaces.
