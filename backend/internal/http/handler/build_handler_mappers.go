...
func toBuildResponse(build domain.Build, project ...*domain.Project) api.BuildResponse {
	...
	return api.BuildResponse{
		...
		SourceAuthorName:              build.SourceAuthorName,
		SourceAuthorEmail:             build.SourceAuthorEmail,
		SourceCommitterName:           build.SourceCommitterName,
		SourceCommitterEmail:          build.SourceCommitterEmail,
		...
		TriggerArtifactPath:           trigger.ArtifactPath,
		TriggerArtifactName:           trigger.ArtifactName,
		TriggerArtifactSizeBytes:      trigger.ArtifactSizeBytes,
