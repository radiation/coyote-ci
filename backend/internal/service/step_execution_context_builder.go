...
func (b *StepExecutionContextBuilder) Build(ctx context.Context, request runner.RunStepRequest) (StepExecutionContext, error) {
	boundRequest, persistedJob := b.bindRequestToPersistedJob(ctx, request)
...
func (b *StepExecutionContextBuilder) bindRequestToPersistedJob(ctx context.Context, request runner.RunStepRequest) (runner.RunStepRequest, *domain.ExecutionJob) {
