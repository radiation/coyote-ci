...
type BuildResponse struct {
	...
	SourceAuthorEmail             *string                    `json:"source_author_email,omitempty"`
	SourceCommitterName           *string                    `json:"source_committer_name,omitempty"`
	SourceCommitterEmail          *string                    `json:"source_committer_email,omitempty"`
	...
	TriggerArtifactID             *string                    `json:"trigger_artifact_id,omitempty"`
	TriggerArtifactPath           *string                    `json:"trigger_artifact_path,omitempty"`
