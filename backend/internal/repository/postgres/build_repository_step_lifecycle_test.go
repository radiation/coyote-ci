...
func TestBuildRepository_ClaimStepIfPending(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "success",
			rows: sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
				AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "default", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 30, "running", nil, nil, nil, nil, now, nil, nil, nil, nil, nil, "[]", nil),
			expectClaim: true,
		},
		{
...
func TestBuildRepository_CompleteStepIfRunning(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "success",
			rows: sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
				AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "default", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 30, "success", nil, nil, nil, nil, now, now, 0, "ok", "", nil, "[]", nil),
...
func TestBuildRepository_CompleteStep_NonFinalSuccess(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 0, "success", nil, nil, nil, nil, now, now, 0, "ok", "", nil, "[]", nil),
	)
	...
	mock.ExpectQuery("SELECT\\s+COUNT\\(\\*\\)::int AS total_count").WithArgs("build-1").WillReturnRows(
		sqlmock.NewRows([]string{"total_count", "success_count", "failed_count", "pending_count", "running_count"}).AddRow(3, 1, 0, 2, 0),
	)
...
func TestBuildRepository_CompleteStep_FinalSuccess(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-2", "build-1", 1, "node-000", nil, "[]", "second", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 0, "success", nil, nil, nil, nil, now, now, 0, "ok", "", nil, "[]", nil),
	)
	mock.ExpectExec("UPDATE builds").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectQuery("SELECT\\s+COUNT\\(\\*\\)::int AS total_count").WithArgs("build-1").WillReturnRows(
		sqlmock.NewRows([]string{"total_count", "success_count", "failed_count", "pending_count", "running_count"}).AddRow(2, 2, 0, 0, 0),
	)
	mock.ExpectExec("UPDATE builds").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectCommit()
...
func TestBuildRepository_CompleteStep_FailedStep(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"echo boom\"]", "{}", ".", 0, "failed", nil, nil, nil, nil, now, now, 7, "", "boom", "boom", "[]", nil),
	)
	mock.ExpectQuery("SELECT\\s+COUNT\\(\\*\\)::int AS total_count").WithArgs("build-1").WillReturnRows(
		sqlmock.NewRows([]string{"total_count", "success_count", "failed_count", "pending_count", "running_count"}).AddRow(2, 0, 1, 1, 0),
	)
...
func TestBuildRepository_CompleteStep_FailedStepNilErrorMessage_UsesTypedBuildUpdate(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"exit 1\"]", "{}", ".", 0, "failed", nil, nil, nil, nil, now, now, 1, "", "command failed", nil, "[]", nil),
	)
	mock.ExpectQuery("SELECT\\s+COUNT\\(\\*\\)::int AS total_count").WithArgs("build-1").WillReturnRows(
		sqlmock.NewRows([]string{"total_count", "success_count", "failed_count", "pending_count", "running_count"}).AddRow(2, 0, 1, 1, 0),
	)
...
func TestBuildRepository_CompleteStep_InvalidTransition(t *testing.T) {
	...
	mock.ExpectQuery("SELECT id, build_id, step_index").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 0, "pending", nil, nil, nil, nil, now, nil, nil, nil, nil, nil, "[]", nil),
	)
	mock.ExpectRollback()
...
func TestBuildRepository_CreateQueuedBuild(t *testing.T) {
	...
	mock.ExpectQuery("INSERT INTO builds").WillReturnRows(
		sqlmock.NewRows([]string{"id", "project_id", "job_id", "status", "created_at", "queued_at", "started_at", "finished_at", "current_step_index", "attempt_number", "rerun_of_build_id", "rerun_from_step_index", "error_message", "pipeline_config_yaml", "pipeline_name", "pipeline_source", "pipeline_path", "repo_url", "ref", "commit_sha", "trigger_kind", "scm_provider", "event_type", "trigger_repository_owner", "trigger_repository_name", "trigger_repository_url", "trigger_raw_ref", "trigger_ref", "trigger_ref_type", "trigger_ref_name", "trigger_deleted", "trigger_commit_sha", "trigger_delivery_id", "trigger_actor"}).
			AddRow("build-1", "project-1", nil, "queued", now, now, nil, nil, 0, 1, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "manual", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil),
	)
...
func TestBuildRepository_ClaimPendingStep(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "default", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 30, "running", "worker-a", "claim-a", now, lease, now, nil, nil, nil, nil, nil, "[]", nil),
	)
...
func TestBuildRepository_ReclaimExpiredStep(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "default", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 30, "running", "worker-b", "claim-b", reclaimBefore, lease, reclaimBefore.Add(-time.Minute), nil, nil, nil, nil, nil, "[]", nil),
	)
...
func TestBuildRepository_CompleteStep_StaleClaim(t *testing.T) {
	...
	mock.ExpectQuery("SELECT id, build_id, step_index").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 0, "running", "worker-b", "claim-b", now, now.Add(time.Minute), now, nil, nil, nil, nil, nil, "[]", nil),
	)
	mock.ExpectCommit()
...
func TestBuildRepository_RenewStepLease_Success(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE build_steps").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 0, "running", "worker-a", "claim-a", now, extended, now, nil, nil, nil, nil, nil, "[]", nil),
	)
...
func TestBuildRepository_RenewStepLease_StaleAndTerminal(t *testing.T) {
	...
	mock.ExpectQuery("SELECT id, build_id, step_index").WillReturnRows(
		sqlmock.NewRows([]string{"id", "build_id", "step_index", "node_id", "group_name", "depends_on_node_ids", "name", "image", "command", "args", "env", "working_dir", "timeout_seconds", "status", "worker_id", "claim_token", "claimed_at", "lease_expires_at", "started_at", "finished_at", "exit_code", "stdout", "stderr", "error_message", "artifact_paths", "cache_config"}).
			AddRow("step-1", "build-1", 0, "node-000", nil, "[]", "first", "", "sh", "[\"-c\",\"echo ok\"]", "{}", ".", 0, "success", "worker-b", nil, nil, nil, now, now, 0, "ok", "", nil, "[]", nil),
	)
