...
func TestArtifactRepository_ListForBrowse(t *testing.T) {
	...
	buildRows := sqlmock.NewRows([]string{
		"id", "build_id", "step_id", "logical_path", "storage_key", "storage_provider", "size_bytes", "content_type", "checksum_sha256", "created_at",
		...
		"artifact-1", "build-1", "step-1", "packages/pkg-a.tgz", "build-1/pkg-a.tgz", "filesystem", int64(12), "application/gzip", "abc123", now,
	...
	mock.ExpectQuery(regexp.QuoteMeta(`
		SELECT 
			a.id, a.build_id, a.step_id, a.logical_path, a.storage_key, a.storage_provider, a.size_bytes, a.content_type, a.checksum_sha256, a.created_at,
