	...
	tests := []struct {
	...
	}{
		{
			...
			expected: Config{
				...
				EmailNotifyCommitAuthorOnFailure: false,
		...
		},
		{
			...
			env: map[string]string{
				...
				"EMAIL_NOTIFY_COMMIT_AUTHOR_ON_FAILURE": "true",
			...
			expected: Config{
				...
				EmailNotifyCommitAuthorOnFailure: true,
		...
		},
		{
			...
			env: map[string]string{
				...
				"EMAIL_NOTIFY_COMMIT_AUTHOR_ON_FAILURE": "not-a-bool",
				"EMAIL_NOTIFICATION_RECIPIENTS":         "",
				"SMTP_HOST":                             "",
				"SMTP_PORT":                             "",
				"SMTP_USERNAME":                         "",
